...
export default class CreateArticleFormService extends AbstractServiceForm<IFormArticleValue> {
    ...
    public submit(formValue: IFormArticleValue): void {
        this.store.dispatch(`${STORE_TOKENS.PAGE_ARTICLES_FORM}/${ECommonActions.SUBMIT}`, formValue);
    }
}
